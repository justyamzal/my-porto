...
const Education = () => {
      return (
    <section id="education"  className="pt-18 pb-28 px-6 md:px-12 lg:px-24 bg-gray-800">
      <h2 id="edu-course-title" className="text-3xl font-bold text-center mb-12">Education & Courses</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
         {/* <!-- Education --> */}
        <div id="edu-col" className="bg-gray-900 p-6 rounded-xl border border-gray-700 hover:border-indigo-500 transition duration-300">
        ...
        {/* <!-- Course --> */}
        <div id="course-col" className="bg-gray-900 p-6 rounded-xl border border-gray-700 hover:border-indigo-500 transition duration-300">
